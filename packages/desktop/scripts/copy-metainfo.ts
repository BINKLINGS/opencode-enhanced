...
const appId = channel === "prod" ? "ai.opencode.enhanced" : `ai.opencode.desktop.${channel}`
const productName = channel === "prod" ? "OpenCode Enhanced" : `OpenCode ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
